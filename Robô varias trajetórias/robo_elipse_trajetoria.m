...
ellipse_a = 2; % Semi-eixo maior
ellipse_b = 1; % Semi-eixo menor

% Calcular coordenadas da elipse
x_ellipse = circle_center_x + ellipse_a * cos(theta_t);
y_ellipse = circle_center_y + ellipse_b * sin(theta_t);
...
for i = 1:num_points
    ...
    x_end_effector(i) = x_ellipse(i);
    y_end_effector(i) = y_ellipse(i);
