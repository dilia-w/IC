...
x_circle = circle_center_x + circle_radius * cos(theta_t);
y_circle = circle_center_y + circle_radius * sin(theta_t);
...
for i = 1:num_points
    ...
    x_end_effector(i) = circle_center_x + circle_radius * cos(theta_t(i));
    y_end_effector(i) = circle_center_y + circle_radius * sin(theta_t(i));
